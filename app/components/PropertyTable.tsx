...
const PropertyTable: React.FC<PropertyTableProps> = ({ info, onSaveToLeads }) => {
  ...
  const handleExportCSV = () => {
    const csv = Papa.unparse([
      {
        'Property Address': info.propertyAddress || 'Not Available',
        'Mailing Address': info.mailingAddress || info.propertyAddress || 'Not Available',
        'HCAD Appraisal': info.appraisal || 'Not Available',
        'Property Owner': info.owner || info.ownerName || 'Not Available',
        'Size': info.size || 'Not Available',
        'Parcel ID': info.parcelId || 'Not Available',
      },
    ]);
